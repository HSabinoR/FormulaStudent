...
void setup()
{
  ...
  // Initialize MCP2515 running at 16MHz with a baudrate 100kb/s and the masks and filters disabled.
...
void loop()
{
  ...
  {
    mcp2515.readMsgBuf(&rxId, &len, rxBuf);      // Read data: len = data length, buf = data byte(s)
